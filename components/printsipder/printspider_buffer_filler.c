...
static uint16_t waveform_tpl_color_b[]={
	0x0,0x0,0xc101,0xc141,0xc042,0x2,0x4101,0x4111,0x4012,0x2,0x4101,0x4301,0x4602,0x402,0x4501,0x4521,0x4422,0x402,0x4000,0x4080,0x4880,0x800,0x800,0x800,0x800,0x800,0x800
};
